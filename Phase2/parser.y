...
/*KEYWORDS*/
%token IF ELSE WHILE FOR FUNCTION RETURN BREAK CONTINUE AND  NOT   OR   LOCAL TRUE FALSE NILL

/*OPERATORS*/   
%token ASSIGNMENT  ADDITION MULTI DIVISION  MODULUSEQUAL    NOTEQUAL INCREMENT  DECREMENT GRETER_THAN  LESS_THAN  GRE_EQUAL LES_EQUAL  
...
/*PUNCTUATIONS MARK*/
%token LEFT_CURLY_BRACKET RIGHT_CURLY_BRACKET RIGHT_SQUARE_BRACKET RIGHT_PARENTHESIS SEMICOLON COMMA SCOPE_RESOLUTION COLON FULL_STOP DOUBLE_FULL_STOP
